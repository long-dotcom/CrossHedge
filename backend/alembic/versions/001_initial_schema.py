...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("environment", sa.String(32), server_default="sandbox", nullable=False),
        sa.Column("enabled", sa.Boolean(), server_default=sa.text("0"), nullable=False),
        sa.Column("read_only", sa.Boolean(), server_default=sa.text("1"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("auto_close_enabled", sa.Boolean(), server_default=sa.text("1"), nullable=False),
        sa.Column("auto_close_live_enabled", sa.Boolean(), server_default=sa.text("0"), nullable=False),
        ...
        sa.Column("paper_use_live_account_risk", sa.Boolean(), server_default=sa.text("0"), nullable=False),
        sa.Column("auto_execute_enabled", sa.Boolean(), server_default=sa.text("0"), nullable=False),
        sa.Column("auto_execute_paper_only", sa.Boolean(), server_default=sa.text("1"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("hl_post_only", sa.Boolean(), server_default=sa.text("0"), nullable=False),
        ...
        sa.Column("mt5_session_enabled", sa.Boolean(), server_default=sa.text("1"), nullable=False),
        sa.Column("mt5_session_auto_sync", sa.Boolean(), server_default=sa.text("1"), nullable=False),
        ...
        sa.Column("allow_hold_through_mt5_close", sa.Boolean(), server_default=sa.text("0"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("post_only", sa.Boolean(), server_default=sa.text("0"), nullable=False),
        sa.Column("reduce_only", sa.Boolean(), server_default=sa.text("0"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("message", sa.Text(), nullable=False),
        sa.Column("acknowledged", sa.Boolean(), server_default=sa.text("0"), nullable=False),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("updated_at", sa.DateTime(), nullable=False),
    )
